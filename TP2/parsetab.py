...
_lr_productions = [
  ...
  ('stat -> VAR = exp','stat',3,'p_stat_0','example_yacc.py',12),
  ('stat -> exp','stat',1,'p_stat_1','example_yacc.py',17),
  ('exp -> exp + exp','exp',3,'p_exp_sum','example_yacc.py',22),
  ('exp -> exp - exp','exp',3,'p_exp_0','example_yacc.py',27),
  ('exp -> exp * exp','exp',3,'p_exp_1','example_yacc.py',32),
  ('exp -> exp / exp','exp',3,'p_exp_2','example_yacc.py',37),
  ('exp -> - exp','exp',2,'p_exp_3','example_yacc.py',42),
  ('exp -> ( exp )','exp',3,'p_exp_4','example_yacc.py',47),
  ('exp -> NUMBER','exp',1,'p_exp_5','example_yacc.py',52),
  ('exp -> VAR','exp',1,'p_exp_6','example_yacc.py',57),
]
